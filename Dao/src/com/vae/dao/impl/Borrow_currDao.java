	...
	public void add(Borrow_curr Borrow_curr) throws SQLException {
		// TODO Auto-generated method stub
		 ...
		 try{
				 ...
				 String bt=dateFormatYMD.format(Borrow_curr.getBorrow_time());
				 String rt=dateFormatMDY.format(Borrow_curr.getShould_return_time());
				 ps.setTimestamp(4, new Timestamp(Borrow_curr.getBorrow_time().getTime()));
				 ps.setTimestamp(5, new Timestamp(Borrow_curr.getShould_return_time().getTime()));
	...
	public void update(Borrow_curr Borrow_curr) throws SQLException {
		// TODO Auto-generated method stub
		 ...
		 try{
				 ...
				 ps.setTimestamp(3, new Timestamp(Borrow_curr.getBorrow_time().getTime()));
				 ps.setTimestamp(4, new Timestamp(Borrow_curr.getShould_return_time().getTime()));

...
INSERT INTO `book` VALUES ('test1','kaka','NO.1',1);
...
CREATE TABLE `borrow_curr` (
  ...
  KEY `bid` (`bid`),
  KEY `userid` (`userid`),
  CONSTRAINT `borrow_curr_ibfk_1` FOREIGN KEY (`bid`) REFERENCES `book` (`bid`),
  CONSTRAINT `borrow_curr_ibfk_2` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`)
...
CREATE TABLE `detailed_book` (
  ...
  `bid` int(11) NOT NULL,
  PRIMARY KEY (`bid`),
  CONSTRAINT `detailed_book_ibfk_1` FOREIGN KEY (`bid`) REFERENCES `book` (`bid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `detailed_user` (
  ...
  PRIMARY KEY (`userid`),
  CONSTRAINT `detailed_user_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `penalty` (
  ...
  KEY `bid` (`bid`),
  KEY `userid` (`userid`),
  CONSTRAINT `penalty_ibfk_1` FOREIGN KEY (`bid`) REFERENCES `book` (`bid`),
  CONSTRAINT `penalty_ibfk_2` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `relation_book` (
  ...
  PRIMARY KEY (`bid`,`cid`),
  KEY `cid` (`cid`),
  CONSTRAINT `relation_book_ibfk_1` FOREIGN KEY (`bid`) REFERENCES `book` (`bid`),
  CONSTRAINT `relation_book_ibfk_2` FOREIGN KEY (`cid`) REFERENCES `category` (`cid`),
  CONSTRAINT `relation_book_ibfk_3` FOREIGN KEY (`bid`) REFERENCES `book` (`bid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-12-30 20:44:55
